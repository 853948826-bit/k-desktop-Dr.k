...
across task types, depending only on success count. These 
results provide empirical evidence that information systems 
exhibit phase-transition-like behavior and establish a minimal 
testbed for studying information physics phenomena.
...
All source code, experimental data, and figure generation 
scripts are available at: \\
\texttt{https://github.com/[repo]/kappa-desktop}
